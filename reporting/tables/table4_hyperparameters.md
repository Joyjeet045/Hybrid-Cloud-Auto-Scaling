...
| ANFIS deadzones | calibrated_mf | True |
...
| Online learning | corrective_weight | 0.35 |
...
| Controller | cda_overflow | True |
| Controller | budget_horizon_frac | 0.6 |
| Controller | spawn_cores | 1 |
| SLO | slo_ms | 500.0 |
